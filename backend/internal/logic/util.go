...
// func removeConnectionFromRoom(ctx context.Context, roomCode string, name string) {
// 	storage := s.RDS
...
// func broadcastToRoom(ctx context.Context, roomCode string, sender string, message map[string]interface{}) (string, error) {
